...
public class MyUse {
	...
	public void seve_img(String imgSrc, String localSrc) throws IOException{
		URL url;
		InputStream is=null;
		url = new URL(imgSrc);
	...
	public String text_getCenterText(String all, String befor, String after) {// 取出中间文本
	...
	public String[] text_getCenterText_batch(String all, String befor, String after) {// 批量取出中间文本
		if (all == null || befor == null || after == null) {
			return null;
		}
	...
	public String codeChange(String str) {
		String newStr=null;
		try {
	...
	public String net_getText(String urlText, String enc) throws IOException {// 网页访问
																				// (访问地址,解码格式)
	...
	public byte[] net_getByte(String urlText) throws IOException {
	...
	public boolean net_browser(String urlText) throws IOException {
	...
	public void setText(String writeMe) {  
